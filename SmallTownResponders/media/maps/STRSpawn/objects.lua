if not getActivatedMods():contains("NewEkron") then
	...
	{ name = "CourtHouseRW", type = "ZombiesType", x = 8051, y = 11642, z = 0, width = 38, height = 29 }, -- Main Building

	-- Louisville Court House
	{ name = "CourtHouseLV", type = "ZombiesType", x = 12458, y = 1527, z = 0, width = 40, height = 39 }, -- Main Building
...
elseif getActivatedMods():contains("NewEkron") then
